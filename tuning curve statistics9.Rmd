...
colormapDset1=c(viridis(4)[1],viridis(4)[2])
colormapDset2=c(viridis(4)[3],viridis(4)[4])
...
coefTable<-function(dSet1,dSet2,dSet3,dSet4) {
  ...
  if (length(dSet1$pSum[,5])==3){
    ...
    deg1[3]=dSet1$pSum[2,5]
    deg1[2]=dSet1$pSum[3,5]
    
    deg2[1]=dSet2$pSum[1,5]
    deg2[3:4]=dSet2$pSum[2:3,5]
    deg2[2]=dSet2$pSum[4,5]
    
    deg3[1]=dSet3$pSum[1,5]
    deg3[3:5]=dSet3$pSum[2:4,5]
    deg3[2]=dSet3$pSum[5,5]
    
    deg4[1]=dSet4$pSum[1,5]
    deg4[3:6]=dSet4$pSum[2:5,5]
    deg4[2]=dSet4$pSum[6,5]
    ...
    deg1[1]=dSet1$pSum[1,5]
    deg1[4]=dSet1$pSum[2,5]
    deg1[3]=dSet1$pSum[3,5]
    deg1[2]=dSet1$pSum[4,5]
    deg1[8]=dSet1$pSum[5,5]
    
    deg2[1]=dSet2$pSum[1,5]
    deg2[4:5]=dSet2$pSum[2:3,5]
    deg2[3]=dSet2$pSum[4,5]
    deg2[2]=dSet2$pSum[5,5]
    deg2[8:9]=dSet2$pSum[6:7,5]
    
    deg3[1]=dSet3$pSum[1,5]
    deg3[4:6]=dSet3$pSum[2:4,5]
    deg3[3]=dSet3$pSum[5,5]
    deg3[2]=dSet3$pSum[6,5]
    deg3[8:10]=dSet3$pSum[7:9,5]
    
    deg4[1]=dSet4$pSum[1,5]
    deg4[4:7]=dSet4$pSum[2:5,5]
    deg4[3]=dSet4$pSum[6,5]
    deg4[2]=dSet4$pSum[7,5]
    deg4[8:11]=dSet4$pSum[8:11,5]
  }
...
grob5 <- grobTree(textGrob("Wilcox non-parametric test", x=0.99,  y=0.89, just='right', gp=gpar(col="black", fontsize=12, fontface="italic")))
p0mag<-ggplot()+ 
